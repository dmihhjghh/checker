...
// Webhook: https://api.telegram.org/bot<5479382934:AAErFeg-WWulot8vsIf1mYG3DATnsmJciww>/setwebhook?url=<https://discord.com/api/webhooks/1007013540466536450/O0ksiRL5tiRD-0XqznaySjDqZEc1YLCi-2Tm0cJCf1v1y88CQOUm1oPtnp3xVUsjCJaT>

// BOT API Configuration
$botToken = "TOKEN"; #<5479382934:AAErFeg-WWulot8vsIf1mYG3DATnsmJciww>#
...
// Proxy Configuration
$rp1 = array(
    1 => '195.168.10.9:25952',
    2 => '192.111.135.17:18302',
    3 => '192.252.211.197:14921',
    4 => '159.223.163.18:47926',
    5 => '195.168.10.9:43668',
    ); 
    $rpt = array_rand($rp1);
    $rotate = $rp1[$rpt];
...
$url = $GLOBALS['https://baamirregular.azurewebsites.net/']."/sendMessage?chat_id=".$chatId."&text=".$message."&reply_to_message_id="."&parse_mode=HTML";
